        ...
        <form action="PublicationsController.php" method="POST" enctype="multipart/form-data">
            <div class="four fields">
                <div class="field">
                    ...
                    <input type="text" name="nombre_p" placeholder="Nombre su Publicacion" value="<?php echo $publicacion->nombre_p; ?>">
                </div>
                <div class="field">
                    <label for="">Informacíon De La Publicacion</label>
                    <input type="text" name="info_p" placeholder="Agrege Informacion Adicional" value="<?php echo $publicacion->info_p; ?>">
                </div>
                <!-- <div class="field">
                ...
                <div class="field">
                    ...
                    <input type="number" name="precios_p" placeholder="Precios" value="<?php echo $publicacion->precios_p; ?>">
                </div>
                <div class="field">
