...
<div class="grid">
  ...
  <form action="UsersController.php" method="POST" class="form login" >
    ...
    <div class="form__field">
      ...
      <input id="login__username" type="text" name="nombre_u" class="form__input" placeholder="Username" value="<?php echo $usuario->nombre_u; ?>" required>
    </div>
    ...
    <div class="form__field">
      ...
      <input id="login__password" type="password" name="contrasena_u" class="form__input" placeholder="Contraseña" value="<?php echo $usuario->contrasena_u; ?>" required>
    </div>
    ...
    <div class="form__field">
      ...
      <input id="login_centro" type="text" name="centro_u" class="form__input" placeholder="Centro Sena" value="<?php echo $usuario->centro_u; ?>" required>
    </div>
