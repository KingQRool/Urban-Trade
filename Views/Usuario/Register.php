        ...
        <div class="grid">
            ...
            <form action="UsersController.php" method="POST" class="form login">
                ...
                <div class="form__field">
                    ...
                    <input id="login__username" type="text" name="nombre_u" class="form__input" placeholder="Nombre"
                        required>
                </div>
            ...
            <p class="text--center">Ya tienes cuenta? <a
                    href="http://localhost/Proyecto Git/Urban-Trade/Controllers/UsersController.php?action=login">Inicia
                    Sesion</a> <svg class="icon">
