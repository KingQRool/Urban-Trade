    ...
    <section class="page-section" id="services" >
        ...
        <section class="page-section" id="contact">
            <div class="container">
                ...
                <form id="contactForm" data-sb-form-api-token="API_TOKEN" action="SuggestionsController.php" method="POST">
                    <div class="row align-items-stretch mb-5">
                        ...
                        <div class="col-md-12">
                            <div class="form-group form-group-textarea mb-md-0">
                                <!-- Message input-->
                                <textarea class="form-control" id="mensaje" name="mensaje_s" placeholder="Tu Mensaje *" data-sb-validations="required"></textarea>
                    ...
                    <!-- Submit Button-->
                    <div class="container">
                    <p style="text-align: center;"> <button  class="btn btn-primary btn-xl text-uppercase" href="">Enviar Sugerencias</button></p>
                    </div>
                </form>
            </div>
        </section>
